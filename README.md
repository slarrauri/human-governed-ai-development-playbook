...
> **Note:** The Spanish (Castellano) version of the site (https://slackdevs.com/es) is provided only for translation review, as it is my native language.  The Spanish site will remain online but may be outdated. Consequently, the language selector on the main site will be removed.
>The valid (authoritative) version is the English site.

> **Nota:** La versión en español (castellano) del sitio (https://slackdevs.com/es) está disponible únicamente para revisión de traducción, ya que es mi lengua materna.  La versión en español permanecerá online pero puede estar desactualizada. Por este motivo, se eliminará el selector de idioma del sitio principal.
>La versión válida (oficial) es la versión en inglés.
## <� What Is This?
...
- **>� AI Executes, Humans Govern** - AI agents handle implementation while humans focus on strategic decisions
- **<
...
- **=� Complete Transparency** - Every action is tracked, documented, and reversible
...
|---|---|
| <� **Prompt Refiner** | Transforms vague requests into actionable specifications |
| =� **Requirements Analyzer** | Extracts and validates technical requirements |
| =� **SDLC Router** | Orchestrates workflow and agent coordination |
| <� **Architecture Agent** | Designs system architecture and technical decisions |
| � **Implementation Agent** | Writes production-ready code |
| >� **Test Agent** | Creates comprehensive test suites |
| = **Security Agent** | Ensures security best practices and vulnerability scanning |
| =� **Performance Agent** | Optimizes for speed, efficiency, and scalability |

| **Specialized Agents** | **Responsibility** |
|---|---|
| =� **Documentation Writer** | Creates technical and user documentation |
| =
 **Internal Reviewer** | Performs code review and quality assurance |
| <? **Branch/PR Manager** | Manages Git workflows and pull requests |
| =� **Deployment Agent** | Handles CI/CD and production deployments |
| =� **Maintenance Agent** | Monitors and maintains deployed systems |
...
```
1. =� Request submitted � Prompt refined
2. =� Requirements analyzed � Architecture designed
3. � Code implemented � Tests written
4. = Security reviewed � Performance optimized
5. =� Documentation generated � Internal review
6. <? Pull request created � Human approval
7. =� Deployment executed � System monitored
```
...
### =� **Core Documentation**
- [<� Getting Started](./docs-en/index.md)
- [=� Manifesto](./docs-en/manifesto.md)
- [9 About the Project](./docs-en/about.md)

### =� **Playbook Guides**
- [� Accelerate Development](./docs-en/human-governed-ai-development-playbook/accelerate-software-development-ai-human-governance.md)
- [=� Boost Productivity](./docs-en/human-governed-ai-development-playbook/boost-productivity-human-governed-ai-development-flows.md)
- [<� Enterprise Governance](./docs-en/human-governed-ai-development-playbook/enterprise-ready-responsible-ai-governance-compliance-framework.md)
...
- [=� Scalable Strategies](./docs-en/human-governed-ai-development-playbook/scalable-ai-development-strategies-any-team-size.md)

### > **Agent Reference**
- [<� All Agents Overview](./docs-en/agents/index.md)
- [=� Requirements Analyzer](./docs-en/agents/requirements_analyzer_agent.md)
- [<� Architecture Agent](./docs-en/agents/architecture_agent.md)
- [� Implementation Agent](./docs-en/agents/implementation_agent.md)
...
[=� Read the Docs](./docs-en/) | [> Explore Agents](./docs-en/agents/) | [=� Quick Start Guide](./docs-en/human-governed-ai-development-playbook/universal-human-governed-ai-development-playbook-configuration-template-quickstart-guide.md)
